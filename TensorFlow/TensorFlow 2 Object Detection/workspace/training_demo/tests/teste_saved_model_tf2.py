...
MODEL_NAME = 'my_mobilenet_v2'
LABEL_FILENAME = 'label_map.pbtxt'

MODELS_DIR = 'D:/TCS/Health Tech/TensorFlow/workspace/training_demo/exported-models'
IMAGE_DIR = 'D:/TCS/Health Tech/TensorFlow/workspace/training_demo/images/test'
...
for image_path in IMAGE_PATHS:
    ...
    plt.savefig(os.path.join(IMAGE_DIR, os.path.join(IMAGE_DIR, image_path)))
    print('Done')
plt.show()
